       program-id. Assignment9 as "Assignment9".
      ...
      ************************************************** 
       01 work-areas.
           ...
           03 wa-telephone          pic x(40).
           03 wa-gender             pic x(40).
      ...
      **************************************************
       ...
       01 main-screen.
           ...
           03 value "]". 
           03 line 15 column 1 value "phone    [".
           03 pic x(40) using wa-telephone highlight prompt " ".
           03 value "]".
           03 line 18 column 1 value "gender   [".
           03 pic x(40) using wa-gender highlight prompt " ".
           03 value "]". 
           03 line 23 column 1 value
              "---------------------------------------------------------
      -       "-----------------------". 
           03 line 24 column 1 value "f1" highlight.
           03 value "=".
           03 value "/h" highlight.
           03 value "elp".
           03 column 30 value "f5" highlight.
           03 value "=display info".
       ...
       01 display-screen.
           03 blank screen.
           03 line 1 column 34 value "Display Screen".
           03 line + 1 column 34 value "--------------".
           03 line 4 value "Name: Jennifer Olenic".
           03 line 6 value "Student ID: 040998261".
           03 line 8 value "Program of Study: Computer Programmer".
      ...
      * Display the help screen and then wait for a key to be pressed.
       ...
       display-info-screen section.
      
      * Display the display screen and then wait for a key to be 
        pressed.
